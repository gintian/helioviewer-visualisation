...
public class GoesTreeNode implements Comparable<GoesTreeNode> {
	...
	public String toString() {
		return "GoesTreeNode [id=" + id + ", level=" + level + ", dirty=" + dirty + ", parentNodeId="
				+ (parentNode != null ? parentNode.getId() : null) + ", timestampInterval=" + timestampInterval
				+ ", minLowChannelLeaf=" + (minLowChannelLeaf != null ? minLowChannelLeaf : null)
				+ ", maxLowChannelLeaf=" + (maxLowChannelLeaf != null ? maxLowChannelLeaf : null)
				+ ", minHighChannelLeaf=" + (minHighChannelLeaf != null ? minHighChannelLeaf : null)
				+ ", maxHighChannelLeaf=" + (minHighChannelLeaf != null ? maxHighChannelLeaf : null) + "]";
	}
	...
	public int compareTo(GoesTreeNode o) {
		...
		if ((thisStartTimestamp != null && otherStartTimestamp == null) || (thisStartTimestamp != null)
				&& thisStartTimestamp.isBefore(otherStartTimestamp)) {
			return -1;
		} else if ((thisStartTimestamp == null && otherStartTimestamp == null) || (thisStartTimestamp != null)
				&& thisStartTimestamp.isEqual(otherStartTimestamp)) {
			return 0;
		} else {
			return 1;
		}
