...
public class GoesSxrLeaf implements Comparable<GoesSxrLeaf> {
	...
	public String toString() {
		return "GoesSxrLeaf [id=" + id + ", parentNodeId=" + (parentNode != null ? parentNode.getId() : null)
				+ ", timestamp=" + timestamp + ", lowChannel=" + lowChannel + ", highChannel=" + highChannel + "]";
	}

	@Override
	public int compareTo(GoesSxrLeaf o) {
		if ((getTimestamp() != null && o.getTimestamp() == null) || (getTimestamp() != null)
				&& getTimestamp().isBefore(o.getTimestamp())) {
			return -1;
		} else if ((getTimestamp() == null && o.getTimestamp() == null) || (getTimestamp() != null)
				&& getTimestamp().isEqual(o.getTimestamp())) {
			return 0;
		} else {
			return 1;
		}
