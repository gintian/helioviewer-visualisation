...
//	private static final Logger logger = LoggerFactory.getLogger(GoesFullDownloader.class);
			...
			if (downloadedFiles.size() > 0) {
				for (File file : downloadedFiles) {
					...
					try {
						...
						final Set<GoesSxrLeaf> parsedLeaves = csvParser.parseFile(maxStartTimestamp, endTimestamp,
								fileReader);
	...
	/**
	 * Download and Save all CSV-Files of working directory to tempFile in folder <code>year</code>.
	 * @param ftpClient
	 * @param year
	 * @return
	 */
	 ...
	 * @throws IOException
	 */
	private void downloadFile(FTPClient ftpClient, String fileUrl, File tempFile) throws FileNotFoundException,
			IOException {
